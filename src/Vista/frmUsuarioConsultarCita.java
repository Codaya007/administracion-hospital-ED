...
public class frmUsuarioConsultarCita extends javax.swing.JFrame {
  ...
  public boolean ExisteEnLista(JTable tabla, String dto, int col) {
    ...
    for (int i = 0; i < tabla.getRowCount(); i++) {
      if (tabla.getValueAt(i, col).equals(dto)) {
        ...
        String NombrePaciente = frmPersonalCitasPorAtender.tblCitasSinAtender
          .getValueAt(i, 2)
          .toString();
        String ApellidoPaciente = frmPersonalCitasPorAtender.tblCitasSinAtender
          .getValueAt(i, 3)
          .toString();
        String FechaCita = frmPersonalCitasPorAtender.tblCitasSinAtender
          .getValueAt(i, 8)
          .toString();
        String HoraCita = frmPersonalCitasPorAtender.tblCitasSinAtender
          .getValueAt(i, 9)
          .toString();
        String CedulaConsulta = frmPersonalCitasPorAtender.tblCitasSinAtender
          .getValueAt(i, 1)
          .toString();
        ...
        JOptionPane.showMessageDialog(
          ...
          " " +
          ApellidoPaciente +
          "  con numero de celuda " +
          CedulaConsulta +
          " \ncuenta con una cita para el dia " +
          FechaCita +
          " en el horario de " +
          HoraCita,
          "CUENTA CON CITA",
  ...
  private void initComponents() {
    ...
    txtNumeroCedula.addFocusListener(
    ...
    txtNumeroCedula.addMouseListener(
    ...
    btnVerificarCita.setIcon(
      new javax.swing.ImageIcon(
        getClass()
          .getResource("/RecursosGraficos/Botones/btnCitaConsultarIcono.png")
      )
    ); // NOI18N
    btnVerificarCita.setText("VERIFICAR CITA");
    btnVerificarCita.addActionListener(
    ...
    jLabel3.setIcon(
      new javax.swing.ImageIcon(
        getClass()
          .getResource("/RecursosGraficos/Fondos/IconoConsultaPanel.png")
      )
    ); // NOI18N
    ...
    barraMovimiento.addMouseMotionListener(
    ...
    barraMovimiento.addMouseListener(
      new java.awt.event.MouseAdapter() {
        public void mousePressed(java.awt.event.MouseEvent evt) {
